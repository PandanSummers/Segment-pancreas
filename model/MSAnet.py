...
class MACblock(nn.Module):
    def __init__(self, channel):
        ...
        self.dilate1 = nn.ConvTranspose2d(channel, channel, kernel_size=3, dilation=1, padding=1)
        self.dilate2 = nn.ConvTranspose2d(channel, channel, kernel_size=3, dilation=4, padding=4)
        self.dilate3 = nn.ConvTranspose2d(channel, channel, kernel_size=3, dilation=6, padding=6)
        self.conT1x1 = nn.ConvTranspose2d(channel, channel, kernel_size=1, dilation=1, padding=0)
